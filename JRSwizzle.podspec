#
#  Be sure to run `pod spec lint jrswizzle.podspec' to ensure this is a
...
s.homepage     = "https://github.com/BadPirate/jrswizzle"
...
s.source       = { :git => "https://github.com/BadPirate/jrswizzle.git", :tag => "v1.0" }
